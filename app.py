...
with st.sidebar:
    st.image(
        "C:/Users/HP/Documents/ML/MNSIT/images/image.jpg",
...
expander.image(
    [
        r"C:\Users\HP\Documents\ML\MNSIT\image.jpg",
        r"C:\Users\HP\Documents\ML\MNSIT\four.png",
        r"C:\Users\HP\Documents\ML\MNSIT\eight.png",
    ],
    width=95,
)
expander.write(
...
st.markdown(
    f"""<div style="text-align: right"> Developed with ❤️ by Piyush Gupta </div>""",
    unsafe_allow_html=True,
)